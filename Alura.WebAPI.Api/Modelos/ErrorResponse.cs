...
namespace Alura.WebAPI.Api.Modelos
{
    public class ErrorResponse
    {
        ...
        public string[] Detalhes { get; set; } //Representa detalhes de cada erro mdo modelState
        ...
        {
            //select many gera uma lista apenas das listas que estavam no segundo nivel
